           ...
           <div class="col-md-6" data-animate="fadeInDown">
               <ul class="menu">
                ...
                <?php }else{ ?>
                   ...
                   <li><a href="register.php?url=add">會員登出</a>
                   </li>
                <?php } ?>
       ...
       <div class="container">
           <div class="navbar-header">
               ...
               <div class="navbar-buttons">
                   ...
                   <a class="btn btn-default navbar-toggle" href="basket.php">
                       ...
                       (<?php if(isset($_POST['Cart']) && $_POST['Cart'] != null ) echo count($_SESSION['Cart']); else echo "0" ; ?>)</span>
                   </a>
               </div>
           </div>
           <!--/.navbar-header -->
           ...
           <div class="navbar-buttons">
               ...
               <div class="navbar-collapse collapse right" id="basket-overview">
                   <a href="basket.php" class="btn btn-primary navbar-btn"><i class="fa fa-shopping-cart"></i><span class="hidden-sm">(<?php if(isset($_POST['Cart']) && $_POST['Cart'] != null ) echo count($_SESSION['Cart']); else echo "0" ; ?>)</span></a>
               </div>
               <!--/.nav-collapse -->
