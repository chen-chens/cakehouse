           ...
           <?php 
             $_SESSION['Cart'] = '0' ; ?>
               <div class="navbar-collapse collapse right" id="basket-overview">
                <a href="web/basket.php" class="btn btn-primary navbar-btn"><i class="fa fa-shopping-cart"></i><span class="hidden-sm">(<?php if(isset($_POST['quantity']) && $_POST['quantity'] != null ) echo count($_SESSION['Cart']); else echo "0" ; ?>)</span></a> 
               </div>
               <!--/.nav-collapse -->
